...
TEST_CASE("Test Simulation of a turn!") {
	...
	actionForSimulation[0] = Action(Coords(13284.f, 5513.f), false, 100); 
	actionForSimulation[1] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[2] = Action(Coords(10892.f, 5909.f), false, 100);
	actionForSimulation[3] = Action(Coords(12440.f, 6181.f), false, 100);
	...
	actionForSimulation[0] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[1] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[2] = Action(Coords(7171.f, 1772.f), false, 100);
	actionForSimulation[3] = Action(Coords(12020.f, 5577.f), false, 100);
	...
	actionForSimulation[0] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[1] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[2] = Action(Coords(7227.f, 1868.f), false, 100);
	actionForSimulation[3] = Action(Coords(11992.f, 5825.f), false, 100);
	...
	actionForSimulation[0] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[1] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[2] = Action(Coords(7339.f, 2036.f), false, 100);
	actionForSimulation[3] = Action(Coords(11976.f, 6041.f), false, 100);
	...
	actionForSimulation[0] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[1] = Action(Coords(13284.f, 5513.f), false, 100);
	actionForSimulation[2] = Action(Coords(7519.f, 2240.f), false, 0);
	actionForSimulation[3] = Action(Coords(11972.f, 6233.f), false, 100);
